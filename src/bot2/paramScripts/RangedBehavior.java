...
public class RangedBehavior extends UnitBehavior {
	...
	public void closestDirectAttack(ParamGeneralScript gs, Unit u, Player p, PhysicalGameState pgs) {
		Unit closestEnemy = null;
        int closestDistance = 0;
        for (Unit u2 : pgs.getUnits()) {
            if (u2.getPlayer() >= 0 && u2.getPlayer() != p.getID()) {
	...
	public void kite(ParamGeneralScript gs, Unit u, Unit u2, PhysicalGameState pgs) {
