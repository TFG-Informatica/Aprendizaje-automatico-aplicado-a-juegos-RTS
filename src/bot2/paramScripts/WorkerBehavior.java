...
public class WorkerBehavior extends UnitBehavior {
	...
	public void harvesterWorker(ParamGeneralScript gs, Unit u, Player p, PhysicalGameState pgs) {
		int nbases = 0;
        int nbarracks = 0;
	...
	public void mixedWorker(ParamGeneralScript gs, Unit u, Player p, PhysicalGameState pgs, int harv) {
		int nbases = 0;
		int nbarracks = 0;
		int harvesting = 0;
        obst = new ArrayList<Pair<Integer, Integer>>();
	...
	public void aggressiveWorker(ParamGeneralScript gs, Unit u, Player p, PhysicalGameState pgs) {
		int nbases = 0;
