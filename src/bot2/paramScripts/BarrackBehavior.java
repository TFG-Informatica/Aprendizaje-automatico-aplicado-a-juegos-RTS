...
public class BarrackBehavior extends UnitBehavior{
	...
	public void trainLight(ParamGeneralScript gs, Unit u, Player p, PhysicalGameState pgs) {
		int nworkers = 0;
	...
	public void trainHeavy(ParamGeneralScript gs, Unit u, Player p, PhysicalGameState pgs) {
		int nworkers = 0;
        for (Unit u2 : pgs.getUnits()) {
            if (u2.getType().equals(workerType)
                    && u2.getPlayer() == p.getID()) {
	...
	public void trainRanged(ParamGeneralScript gs, Unit u, Player p, PhysicalGameState pgs) {
		int nworkers = 0;
        for (Unit u2 : pgs.getUnits()) {
            if (u2.getType().equals(workerType)
                    && u2.getPlayer() == p.getID()) {
	...
	public void trainLess(ParamGeneralScript gs, Unit u, Player p, PhysicalGameState pgs) {
